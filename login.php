...
<div style=" background-color: silver; Height: 267px; width: 350px; padding-left: 30px; padding-top: 10px; border-radius: 25px; border-right: 5px solid black; border-top: 5px	solid black; border-bottom: 5px solid black;">
	<form action="loginPhp.php" method="post" style=" width: 311px; height: 205px; left: 0px; top: 0px;" class="auto-style2">
...
<div style=" background-color: silver; Height: 420px; width: 350px; padding-left: 30px; padding-top: 10px; border-radius: 25px; border-right: 5px solid black; border-top: 5px	solid black; border-bottom: 5px solid black;">
<form method="GET" action="testDnew.php" style="width: 311px; height: 323px; left: 0px; top: 0px;" class="auto-style2">
